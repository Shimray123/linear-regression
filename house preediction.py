...
Original file is located at
    https://colab.research.google.com/drive/1dIbV_rz8fF4B70mEQM2n1yGpkrQPh6GI
"""
...
print("mean absolute error onn TEST DATA of Linear Regression:",metrics.mean_absolute_error(y_test,y_pred))
print("mean squared error onn TEST DATA of Linear Regression:",metrics.mean_squared_error(y_test,y_pred))
print("root mean squared error onn TEST DATA of Linear Regression:",np.sqrt(metrics.mean_squared_error(y_test,y_pred)))
...
ax.bar(x=lr_coefficient["columns"], height=lr_coefficient["Coefficient Estimate"])
...
fig, ax = plt.subplots(figsize=(20, 10))
color = ['tab:gray','tab:blue','tab:orange','tab:brown','tab:green','tab:red','tab:purple','tab:pink','tab:olive','tab:cyan','tab:gray']
